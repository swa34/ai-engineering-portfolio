...
3. Switch to **Reviewer** and open the cycle. Compare the frozen source, generated wording, validation findings, and revision history. Editing is optional. Wording that departs from the source-based template cannot be approved; restoring wording creates another revision when saved.
